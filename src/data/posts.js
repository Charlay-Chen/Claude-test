export const posts = [
  {
    ...
    date: '2026-04-20',
    tags: ['Vue', 'JavaScript'],
    excerpt: '组合式 API 是 Vue 3 最重要的特性之一，它提供了一种更灵活的方式来组织组件逻辑。本文介绍 setup、ref、reactive 等核心概念。',
    content: `
  ...
  {
    id: 2,
    title: 'Vite — 新一代前端构建工具',
    date: '2026-04-25',
    tags: ['Vite', '前端工具'],
    excerpt: 'Vite 利用浏览器原生 ES 模块支持，实现了极速的开发服务器启动和热更新。',
    content: `
  ...
  },
  {
    ...
    date: '2026-05-01',
    tags: ['Element Plus', 'UI 组件', 'Vue'],
    excerpt: 'Element Plus 是 Vue 3 生态中最流行的 UI 组件库之一。本文分享一些实用的使用技巧和最佳实践。',
    content: `
  ...
  {
    id: 4,
    title: 'Vue Router 路由管理指南',
    date: '2026-05-05',
    tags: ['Vue Router', '路由'],
    excerpt: '在单页应用中，路由是核心机制之一。Vue Router 4 为 Vue 3 提供了强大而灵活的路由功能。',
    content: `
  ...
  },
  {
    ...
    date: '2026-05-08',
    tags: ['CSS', '布局'],
    excerpt: 'Flexbox 是现代 CSS 布局的基础，掌握它可以轻松实现各种复杂的页面布局效果。',
    content: `
